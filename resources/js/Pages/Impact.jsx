...
export default function Impact({ impactActivities }) {
    ...
    const renderCard = (impact, idx, mode) => {
        ...
        const props = {
            key: impact.id,
            index: idx,
            image: impact.image ? `/uploads/images/${impact.image}` : null,
    ...
    return (
        <>
            ...
            <PageHeader title="Our Impact" breadcrumb={[{ label: 'Our Impact' }]} />
